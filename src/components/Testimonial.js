...
const Testimonial = () => {
    ...
    >
      <motion.div
        ...
        className="flex-[0.5] lg:max-w-[370px] flex justify-end flex-col sm:py-8 p-4 rounded-[32px] border-[1px] border-[#6A6A6A] relative"
      >
        <div className="feedback-gradient" />
        <div className='flex'>
        <div>
        <h4 className="font-bold sm:text-[20px] text-[26px] text-white">
          Vivek <br></br>Atray
          </h4>
          ...
          src="/Vivek_Atray.jpg"
          alt="pfp"
          className="lg:h-[80px] ml-8 h-auto min-h-[20px] object-cover rounded-full"
        />
        </div>

        <p className="mt-[24px] font-normal sm:text-[14px] text-[14px] sm:leading-[25px] text-white">
